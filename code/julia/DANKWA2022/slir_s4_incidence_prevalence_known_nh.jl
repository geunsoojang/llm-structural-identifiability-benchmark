...
ode = @ODEmodel(
    S'(t) = -b*S(t)*In(t)/(S(t) + L(t) + In(t) + R(t)),
    L'(t) = b*S(t)*In(t)/(S(t) + L(t) + In(t) + R(t)) - a*L(t),
    In'(t) = a*L(t) - g*In(t),
    R'(t) = g*In(t),
    y1(t) = a*L(t),
    y2(t) = In(t)/(S(t) + L(t) + In(t) + R(t)),
    y_g(t) = g,
    y_a(t) = a
)

known_states = [S, L, In, R]
...
run_case("slir_s4_incidence_prevalence_known_nh unknown initial conditions", "slir_s4_incidence_prevalence_known_nh_unknown_initial.txt")
run_case("slir_s4_incidence_prevalence_known_nh known initial conditions", "slir_s4_incidence_prevalence_known_nh_known_initial.txt", known_ic = known_states)
