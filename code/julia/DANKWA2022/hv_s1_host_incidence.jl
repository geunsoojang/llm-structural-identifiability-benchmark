...
run_case("hv_s1_host_incidence unknown initial conditions", "hv_s1_host_incidence_unknown_initial.txt")
run_case("hv_s1_host_incidence known initial conditions", "hv_s1_host_incidence_known_initial.txt", known_ic = known_states)
