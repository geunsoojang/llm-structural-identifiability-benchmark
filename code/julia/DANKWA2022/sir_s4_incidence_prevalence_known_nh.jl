...
run_case("sir_s4_incidence_prevalence_known_nh unknown initial conditions", "sir_s4_incidence_prevalence_known_nh_unknown_initial.txt")
run_case("sir_s4_incidence_prevalence_known_nh known initial conditions", "sir_s4_incidence_prevalence_known_nh_known_initial.txt", known_ic = known_states)
