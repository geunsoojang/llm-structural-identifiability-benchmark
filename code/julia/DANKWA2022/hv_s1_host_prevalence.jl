...
run_case("hv_s1_host_prevalence unknown initial conditions", "hv_s1_host_prevalence_unknown_initial.txt")
run_case("hv_s1_host_prevalence known initial conditions", "hv_s1_host_prevalence_known_initial.txt", known_ic = known_states)
