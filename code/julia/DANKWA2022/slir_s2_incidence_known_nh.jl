...
run_case("slir_s2_incidence_known_nh unknown initial conditions", "slir_s2_incidence_known_nh_unknown_initial.txt")
run_case("slir_s2_incidence_known_nh known initial conditions", "slir_s2_incidence_known_nh_known_initial.txt", known_ic = known_states)
