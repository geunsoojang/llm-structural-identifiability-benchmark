...
run_case("slir_s1_incidence unknown initial conditions", "slir_s1_incidence_unknown_initial.txt")
run_case("slir_s1_incidence known initial conditions", "slir_s1_incidence_known_initial.txt", known_ic = known_states)
