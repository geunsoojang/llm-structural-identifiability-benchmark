...
ode = @ODEmodel(
    ...
    y1(t) = In(t)/(S(t) + L(t) + In(t) + R(t) + Q(t)),
    y_g(t) = g,
    y_a(t) = a,
    y_e(t) = e,
    y_s(t) = s
...
run_case("slirq_s2_prevalence_known_nh unknown initial conditions", "slirq_s2_prevalence_known_nh_unknown_initial.txt")
run_case("slirq_s2_prevalence_known_nh known initial conditions", "slirq_s2_prevalence_known_nh_known_initial.txt", known_ic = known_states)
