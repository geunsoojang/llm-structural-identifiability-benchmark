...
run_case("slirq_s3_incidence_prevalence unknown initial conditions", "slirq_s3_incidence_prevalence_unknown_initial.txt")
run_case("slirq_s3_incidence_prevalence known initial conditions", "slirq_s3_incidence_prevalence_known_initial.txt", known_ic = known_states)
