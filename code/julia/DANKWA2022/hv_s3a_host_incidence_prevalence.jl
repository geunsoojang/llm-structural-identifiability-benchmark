...
run_case("hv_s3a_host_incidence_prevalence unknown initial conditions", "hv_s3a_host_incidence_prevalence_unknown_initial.txt")
run_case("hv_s3a_host_incidence_prevalence known initial conditions", "hv_s3a_host_incidence_prevalence_known_initial.txt", known_ic = known_states)
