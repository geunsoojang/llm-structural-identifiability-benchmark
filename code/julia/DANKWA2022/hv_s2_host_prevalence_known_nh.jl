...
run_case("hv_s2_host_prevalence_known_nh unknown initial conditions", "hv_s2_host_prevalence_known_nh_unknown_initial.txt")
run_case("hv_s2_host_prevalence_known_nh known initial conditions", "hv_s2_host_prevalence_known_nh_known_initial.txt", known_ic = known_states)
