...
run_case("sir_s1_incidence unknown initial conditions", "sir_s1_incidence_unknown_initial.txt")
run_case("sir_s1_incidence known initial conditions", "sir_s1_incidence_known_initial.txt", known_ic = known_states)
