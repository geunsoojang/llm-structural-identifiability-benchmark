...
ode = @ODEmodel(
    S'(t) = -(betap*Ip(t) + betaI*I(t))*S(t)/(S(t)+E(t)+Ip(t)+I(t)+R(t)),
    E'(t) = (betap*Ip(t) + betaI*I(t))*S(t)/(S(t)+E(t)+Ip(t)+I(t)+R(t)) - k*E(t),
    Ip'(t) = k*E(t) - kp*Ip(t) - gammap*Ip(t),
    I'(t) = kp*Ip(t) - gamma*I(t) - delta*I(t),
    R'(t) = gamma*I(t) + gammap*Ip(t),
    D'(t) = delta*I(t),
    y1(t) = kp*Ip(t),
    y2(t) = delta*I(t)
)

known_states = [S, E, Ip, I, R, D]

result_dir = joinpath(pwd(), "result")
mkpath(result_dir)
out_file = joinpath(result_dir, "Model8b_unknown_initial.txt")
...
open(out_file, "w") do io
    redirect_stdout(io) do
        redirect_stderr(io) do
            println("LIYANAGE2026 Model8b_unknown_initial")
            println()
