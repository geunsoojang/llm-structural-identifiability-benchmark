...
run_case("sidarthe_direct_outputs unknown initial conditions", "sidarthe_direct_outputs_unknown_initial.txt")
run_case("sidarthe_direct_outputs known initial conditions", "sidarthe_direct_outputs_known_initial.txt", known_ic = known_states)