...
run_case("seir_infectious_prevalence unknown initial conditions", "seir_infectious_prevalence_unknown_initial.txt")
run_case("seir_infectious_prevalence known initial conditions", "seir_infectious_prevalence_known_initial.txt", known_ic = known_states)