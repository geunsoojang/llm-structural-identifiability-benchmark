...
run_case("seuir_reparam_reported_prevalence unknown initial conditions", "seuir_reparam_reported_prevalence_unknown_initial.txt")
run_case("seuir_reparam_reported_prevalence known initial conditions", "seuir_reparam_reported_prevalence_known_initial.txt", known_ic = known_states)